...
<div class="col-md-3">
    <div class="card shadow-lg border-0 h-100">
        <div class="card-body text-center">
            ...
            <a href="{{ url('/akun') }}" class="btn btn-primary w-100 text-white">Kelola</a>
        </div>
    </div>
</div>
...
<div class="col-md-3">
    <div class="card shadow-lg border-0 h-100">
        <div class="card-body text-center">
            ...
            <a href="{{ url('/mahasiswa') }}" class="btn btn-primary w-100 text-white">Kelola</a>
        </div>
    </div>
</div>
...
<div class="col-md-3">
    <div class="card shadow-lg border-0 h-100">
        <div class="card-body text-center">
            ...
            <a href="{{ url('/data_dosen') }}" class="btn btn-primary w-100 text-white">Kelola</a>
        </div>
    </div>
</div>
