        ...
        <div class="col-lg-7">
            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-5">
                    ...
                    <div class="text-center mb-4">
                        ...
                        @isset($kelompok)
                            <p class="text-muted mb-0">
                                Kelompok <span class="fw-semibold">{{ $kelompok->nama_kelompok }} (ID: {{ $kelompok->id_kelompok }})</span>
                            </p>
                        @else
                            <p class="text-muted mb-0">Kelompok tidak diketahui</p>
                        @endisset
                        <hr class="mt-3 mb-0">
                    </div>
                    ...
                    <!-- Form -->
                    <form action="{{ route('milestone.store') }}" method="POST" class="mt-4">
                        @csrf
            ...
            <div class="text-center mt-4">
                <a href="{{ route('milestone.view') }}" class="text-decoration-none text-secondary">
