...
@section('content')
@php
    // Role yang dibatasi (tidak bisa menambah / edit / hapus)
...
<div class="container mt-4">
    ...
    <div class="row mb-3">
        ...
        {{-- Tombol Tambah Dosen (khusus admin) --}}
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped align-middle">
                    ...
                    <tbody>
                        @forelse ($dosens as $item)
                            <tr>
                                <td class="text-center">
                                    {{ $loop->iteration + ($dosens->currentPage() - 1) * $dosens->perPage() }}
                                </td>
                                <td>{{ $item->nama }}</td>
                                <td>{{ $item->nip }}</td>
                                <td>{{ $item->email }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="{{ $isRestricted ? 7 : 8 }}" class="text-center text-muted">
