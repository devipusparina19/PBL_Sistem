...
<div class="container mt-4">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <div class="alert alert-info">
                ...
                <p class="mb-2">Bandingkan setiap pasang kriteria. Pilih seberapa penting kriteria <strong>BARIS</strong> dibandingkan <strong>KOLOM</strong>.</p>
                <ul class="mb-0">
    ...
    <div class="card mt-4 shadow-sm">
        <div class="card-header bg-secondary text-white">
            <h5 class="mb-0"><i class="bi bi-book"></i> Tentang AHP</h5>
        </div>
        <div class="card-body">
            <h6>Langkah Perhitungan AHP:</h6>
            <ol>
                <li>Buat matriks perbandingan berpasangan</li>
                <li>Normalisasi setiap kolom (bagi dengan jumlah kolom)</li>
                <li>Hitung bobot = rata-rata setiap baris</li>
                <li>Hitung Consistency Ratio (CR)</li>
                <li>Jika CR ≤ 10%, matriks konsisten dan bobot valid</li>
            </ol>
            <div class="alert alert-warning">
                <i class="bi bi-exclamation-triangle"></i> 
                <strong>Catatan:</strong> Jika CR > 10%, hasil tidak konsisten dan Anda perlu memperbaiki perbandingan.
            </div>
        </div>
    </div>
</div>
